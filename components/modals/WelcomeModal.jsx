...
import { DISCORD_INVITE } from './DiscordModal'
 ...
 *
 * L'invitation Discord est intégrée ICI plutôt que dans une popup séparée :
 * un nouvel inscrit se prenait sinon trois fenêtres d'affilée à l'arrivée.
 */
  ...
  return (
    <Modal onClose={onClose}>
      <div className="modal-body">
        ...
        <button className="btn-add" style={{ marginTop: '10px' }} onClick={onClose}>
          C'est parti !
        </button>
      </div>
    </Modal>
